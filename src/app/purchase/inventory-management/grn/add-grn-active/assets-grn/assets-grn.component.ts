...
import { AddAssetsGrnComponent } from './add-assets-grn/add-assets-grn.component';

@Component({
  selector: 'app-assets-grn',
  templateUrl: './assets-grn.component.html',
  styleUrls: ['./assets-grn.component.scss']
})
export class AssetsGrnComponent implements OnInit {
  ...
  openActionTypeDialog(value) {
    let dialogRef = this.dialog.open(AddAssetsGrnComponent, {
      data: value,
      height: 'auto',
      width: '600px',
  });
