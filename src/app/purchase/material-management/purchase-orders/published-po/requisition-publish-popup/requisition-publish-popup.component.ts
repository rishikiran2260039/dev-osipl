...
@Component({
  selector: 'app-requisition-publish-popup',
  templateUrl: './requisition-publish-popup.component.html',
  styleUrls: ['./requisition-publish-popup.component.scss']
})
export class RequisitionPublishPopupComponent implements OnInit {

  constructor(public dialog:MatDialogRef<RequisitionPublishPopupComponent>) { }
