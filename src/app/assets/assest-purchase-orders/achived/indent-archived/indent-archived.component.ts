...
@Component({
  selector: 'app-indent-archived',
  templateUrl: './indent-archived.component.html',
  styleUrls: ['./indent-archived.component.scss']
})
export class IndentArchivedComponent implements OnInit {

  constructor(public dialog:MatDialogRef<IndentArchivedComponent>) { }
