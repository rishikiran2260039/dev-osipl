...
@Component({
  selector: 'app-invoice-published',
  templateUrl: './invoice-published.component.html',
  styleUrls: ['./invoice-published.component.scss']
})
export class InvoicePublishedComponent implements OnInit {
  constructor(public dialog:MatDialogRef< InvoicePublishedComponent >) { }
