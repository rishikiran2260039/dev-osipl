...
@Component({
  selector: 'app-add-class-master',
  templateUrl: './add-class-master.component.html',
  styleUrls: ['./add-class-master.component.scss']
})
export class AddClassMasterComponent implements OnInit {

  selectedPosition: { id: number; value: string; }[];
  selectedItemCode: { id: number; value: string; }[];

  constructor(public dialog : MatDialogRef<AddClassMasterComponent>,@Inject(MAT_DIALOG_DATA) public data:any) { }
