...
import { AddAssetsToUnpublishedComponent } from './add-assets-to-unpublished/add-assets-to-unpublished.component';

@Component({
  selector: 'app-assets-unpublished-po',
  templateUrl: './assets-unpublished-po.component.html',
  styleUrls: ['./assets-unpublished-po.component.scss']
})
export class AssetsUnpublishedPoComponent implements OnInit {
  ...
  openActionTypeDialog(value) {
    let dialogRef = this.dialog.open(AddAssetsToUnpublishedComponent, {
      data: value,
      height: 'auto',
      width: '600px',
  });
