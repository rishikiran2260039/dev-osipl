...
import { AddRequisitionDialogServicecontractsComponent } from './add-requisition-dialog-servicecontracts/add-requisition-dialog-servicecontracts.component';

@Component({
  selector: 'app-requistion-service-contracts',
  templateUrl: './requistion-service-contracts.component.html',
  styleUrls: ['./requistion-service-contracts.component.scss']
})
export class RequistionServiceContractsComponent implements OnInit {
  ...
  public addrequisition(item) {
    let dialogRef = this.dialog.open(AddRequisitionDialogServicecontractsComponent, {
      data:item,
      height: 'auto',
      width: 'auto'
    });
