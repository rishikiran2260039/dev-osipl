...
import { AddAssetsToPublishedComponent } from './add-assets-to-published/add-assets-to-published.component';

@Component({
  selector: 'app-assets-published-po',
  templateUrl: './assets-published-po.component.html',
  styleUrls: ['./assets-published-po.component.scss']
})
export class AssetsPublishedPoComponent implements OnInit {
  ...
  openActionTypeDialog(value) {
    let dialogRef = this.dialog.open(AddAssetsToPublishedComponent, {
      data: value,
      height: 'auto',
      width: '600px',
  });
