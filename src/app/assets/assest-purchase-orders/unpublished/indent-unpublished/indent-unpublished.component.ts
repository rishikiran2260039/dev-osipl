...
@Component({
  selector: 'app-indent-unpublished',
  templateUrl: './indent-unpublished.component.html',
  styleUrls: ['./indent-unpublished.component.scss']
})
export class IndentUnpublishedComponent implements OnInit {

  constructor(public dialog:MatDialogRef<IndentUnpublishedComponent>) { }
