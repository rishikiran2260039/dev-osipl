...
export class AgingAnalysisComponent implements OnInit {
  ...
  items = [
    {period:'0-10',inv:'12',amt:'560,000'}, 
    {period:'11-30',inv:'2',amt:'45,600'}, 
    {period:'31-60',inv:'14',amt:'660,000'}, 
    {period:'61-90',inv:'1',amt:'12,500'}, 
    {period:'91-120',inv:'20',amt:'760,000'}, 
    {period:'121-150',inv:'3',amt:'49,600'}, 
    {period:'151-180',inv:'8',amt:'69,600'}, 
    {period:'180+',inv:'28',amt:'89,600'}, 
    ];
 ...
 public autoScale = true; 
  ...
  constructor(
    ...
    const single = [
      {
        name: 'Billed (Not Yet Due)',
        value: 30
      },
      {
        name: 'Overdue (0-30 days)',
        value: 30
      },
      {
        name: 'Late (30 days +)',
  ...
  hardcodeChart() {
    this.monthyPulseOfEmployees = new Chart({
      ...
      series: [ {
        name: 'Payments',
        data: [190000,270000,520000,900000,300000,270000,140000,250000,400000,370000,240000,350000,]
      }, {
        name: 'Payables',
        data: [160000,230000,480000,850000,260000,200000,100000,200000,360000,300000,200000,300000]
      }]
