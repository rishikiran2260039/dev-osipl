...
import { AddAssetsArnComponent } from './add-assets-arn/add-assets-arn.component';

@Component({
  selector: 'app-assets-arn',
  templateUrl: './assets-arn.component.html',
  styleUrls: ['./assets-arn.component.scss']
})
export class AssetsArnComponent implements OnInit {
  ...
  openActionTypeDialog(value) {
    let dialogRef = this.dialog.open(AddAssetsArnComponent, {
      data: value,
      height: 'auto',
      width: '600px',
  });
