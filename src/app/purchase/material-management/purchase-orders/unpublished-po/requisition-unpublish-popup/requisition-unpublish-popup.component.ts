...
@Component({
  selector: 'app-requisition-unpublish-popup',
  templateUrl: './requisition-unpublish-popup.component.html',
  styleUrls: ['./requisition-unpublish-popup.component.scss']
})
export class RequisitionUnpublishPopupComponent implements OnInit {

  constructor(public dialog:MatDialogRef<RequisitionUnpublishPopupComponent>) { }
