...
import { AddEditRequisitionComponent } from './store-in-charge/add-edit-requisition/add-edit-requisition.component';
...
export class RequisitionComponent implements OnInit {
  ...
  public addrequisition(item) {
    let dialogRef = this.dialog.open(AddRequisitionDialogComponent, {
      data:item,
      height: 'auto',
      width: 'auto'
    });
