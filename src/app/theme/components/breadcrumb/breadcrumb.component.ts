...
export class BreadcrumbComponent {
    ...
    constructor(public appSettings: AppSettings,
        ...
        this.description = {
            "Assets-Indent":"Requisitions for new assets can be raised here",
            "Assets-RFQ":"Asset suppliers can be requested to submit quotations for new asset requirements over here.",
            "OEM-Master":"Suppliers from who the assets are purchased can be updated here",
            "Class-Master":"This is the cross reference list of asset types",
            "Assets-Categories":"The master list of asset categories can be managed here",
            "Event Log":"Event Log",
            "Project Handover":"The list of tasks in the project handover checklist can be managed here",
            "PO Bill Status":"The list of tasks in the PO Bill Status handover can be managed here",
            "Project Reports":"The list of reports checklist can be managed here",
            ...
            "Dashboard": "The overall summary of System Activity, Usage and Statistics are provided in this screen",
            ...
            "Order Status": "The list of Orders information associated to the purchase is listed here. Ability to add and manage purchase information can be done here",
            ...
            "Indent": "Indent is an item requirements list that can be initiated and approved on this screen by authorized personal only. User selects type, category, item and other details and needs an approval before it is submitted for approval.",
            ...
            "Consignments": "Add consignments, manage items, input invoicing details and manage consignments logistics from this screen.",
            "Add Consignments": "Add consignments, manage items, input invoicing details and manage consignments logistics from this screen.",
            ...
            "ARN": "All the goods that are received at the gate are recorded in the system using this screen. User needs to select the indent and then the consignment and add the GRN for that particular consignment.",
            ...
            "Rentals": "The list of external equipment taken for each project on the site can be managed and the monthly lease payments can be tracked here",
            ...
            "Kanban": "Customize Sales/Marketing steps as per the requirement",
            ...
            "Perfomance Master" :"Admin can add perfomance with a specific name and incharge to different projects in the system.",
            ...
            "Income" : "This screen is used to show Incomes",
            "Documents" : "This is Documents Screen",
            "Notifications" : "This is Notifications Screen",


            "Long Lead Order Status":"Here is a summary of delivery status and transit details for long lead items.",
             "Assets":"The list of assets can be managed here",
             "Assets-Warranty":" The contracts for maintenance of assets including both warranty and AMC are updated here",
             "Assets-Master":" This screen covers Comprehensive list of Assets across the application. New data can be added, deleted or modified according to fuctionality.",
             "Asset Master":" This screen covers Comprehensive list of Assets across the application. New data can be added, deleted or modified according to fuctionality."
