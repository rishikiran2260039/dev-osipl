...
@Component({
  selector: 'app-add-item-reorder',
  templateUrl: './add-item-reorder.component.html',
  styleUrls: ['./add-item-reorder.component.scss']
})
export class AddItemReorderComponent implements OnInit {

  selectedPosition: { id: number; value: string; }[];
  selectedItemCode: { id: number; value: string; }[];

  constructor(public dialog : MatDialogRef<AddItemReorderComponent>,@Inject(MAT_DIALOG_DATA) public data:any) { }
