...
import { AddgrnitemshipqntyComponent } from './addgrnitemshipqnty/addgrnitemshipqnty.component';

@Component({
  selector: 'app-items-active-grn',
  templateUrl: './items-active-grn.component.html',
  styleUrls: ['./items-active-grn.component.scss']
})
export class ItemsActivegrnComponent implements OnInit {
  ...
  {
    let dialogRef = this.dialog.open(AddgrnitemshipqntyComponent, {
      height: 'auto',
      width: '500px',
  });
  }
