...
@Component({
  selector: 'app-items-archived',
  templateUrl: './items-archived.component.html',
  styleUrls: ['./items-archived.component.scss']
})
export class ItemsArchivedComponent implements OnInit {
