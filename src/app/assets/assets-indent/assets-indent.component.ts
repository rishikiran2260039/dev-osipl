...
import { AddEditRequisitionComponent } from 'src/app/purchase/requisition/store-in-charge/add-edit-requisition/add-edit-requisition.component';
import { AddAssetsIndentComponent } from './add-assets-indent/add-assets-indent.component';

@Component({
  selector: 'app-assets-indent',
  templateUrl: './assets-indent.component.html',
  styleUrls: ['./assets-indent.component.scss']
})
export class AssetsIndentComponent implements OnInit {
  ...
  public addrequisition(item) {
    let dialogRef = this.dialog.open(AddAssetsIndentComponent, {
      data:item,
      height: 'auto',
      width: 'auto'
    });
...
public openAddProjectDialog(item){
  let dialogRef = this.dialog.open(AddAssetsIndentComponent, {
    data:item,
    height: 'auto',
    width: 'auto'
