...
export class LayoutComponent implements OnInit {
  ...
  constructor(public tourService: TourService,public dialog: MatDialog,public appSettings: AppSettings, public router: Router, private menuService: MenuService) {
    this.settings = this.appSettings.settings;
    this.checkclient = localStorage.getItem("isosipladmin");
