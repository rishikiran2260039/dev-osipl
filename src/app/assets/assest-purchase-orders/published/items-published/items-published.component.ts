...
@Component({
  selector: 'app-items-published',
  templateUrl: './items-published.component.html',
  styleUrls: ['./items-published.component.scss']
})
export class ItemsPublishedComponent implements OnInit {
