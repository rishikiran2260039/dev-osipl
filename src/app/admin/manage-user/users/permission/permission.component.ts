...
export class PermissionComponent implements OnInit {
  ...
  constructor(private _location: Location,public router:Router,private service: UsersService,private _activeRoute: ActivatedRoute,private location:Location,private alertService: AlertService, ) {
