...
@Component({
  selector: 'app-add-asset-item-dialog',
  templateUrl: './add-asset-item-dialog.component.html',
  styleUrls: ['./add-asset-item-dialog.component.scss']
})
export class AddAssetItemDialogComponent implements OnInit {

  selectedPosition: { id: number; value: string; }[];
  selectedItemCode: { id: number; value: string; }[];

  constructor(public dialog : MatDialogRef<AddAssetItemDialogComponent>,@Inject(MAT_DIALOG_DATA) public data:any) { }
