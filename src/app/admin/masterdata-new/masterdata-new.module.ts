...
import { AddRegionComponent } from './country/add-region/add-region.component';
import { HandoverMasterComponent } from './handover-master/handover-master.component';
import { AddhandovermasterComponent } from './handover-master/addhandovermaster/addhandovermaster.component';
import { ServicePerfomanceComponent } from './service-perfomance/service-perfomance.component';
import { SupplyPerfomanceComponent } from './supply-perfomance/supply-perfomance.component';
import { AddSupplyPerfomanceComponent } from './supply-perfomance/add-supply-perfomance/add-supply-perfomance.component';
import { AddServicePerfomanceComponent } from './service-perfomance/add-service-perfomance/add-service-perfomance.component';

export const routes = [
  { path: '', redirectTo: 'handover', pathMatch: 'full' },
  ...
  { path: 'region', component: RegionComponent, data: { breadcrumb: 'Manage User' } },
  ...
  { path: 'handover', component: HandoverMasterComponent, data: { breadcrumb: 'Manage User' } },
