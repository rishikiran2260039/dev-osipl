...
import { AddPerfomanceMasterComponent } from './add-perfomance-master/add-perfomance-master.component';

@Component({
  selector: 'app-perfomance-master',
  templateUrl: './perfomance-master.component.html',
  styleUrls: ['./perfomance-master.component.scss']
})
export class PerfomanceMasterComponent implements OnInit {
  ...
  openActionTypeDialog(value) {
    let dialogRef = this.dialog.open(AddPerfomanceMasterComponent, {
      data: value,
      height: 'auto',
      width: '600px',
  });
