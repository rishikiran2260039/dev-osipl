...
import { QuantityPopUpComponent } from './quantity-pop-up/quantity-pop-up.component';

@Component({
  selector: 'app-asset-master-setup',
  templateUrl: './asset-master-setup.component.html',
  styleUrls: ['./asset-master-setup.component.scss']
})
export class AssetMasterSetupComponent implements OnInit {
