...
import { AddQuantityUpdatePopupComponent } from './add-quantity-update-popup/add-quantity-update-popup.component';

@Component({
  selector: 'app-qalog-grn',
  templateUrl: './qalog-grn.component.html',
  styleUrls: ['./qalog-grn.component.scss']
})
export class QalogGrnComponent implements OnInit {
  ...
  items = [
    {itemname:"Volvo",itemcode:"	FMX480",category:"Dump Truck",subcategory:"Breakdown Repairs",orderqty:"25",previousreceipt:"27-01-2020",currentreceipt:"12-06-2021",qtyrecived:"25",qtyaccepted:"24",qtydeclined:"1",remarks:"immediate Despatch of goods required"},
    ...
    {itemname:"Tata",itemcode:"	ACTROS 4841K",category:"	Dump Truck",subcategory:"Breakdown Repairs",orderqty:"16",previousreceipt:"13-03-2020",currentreceipt:"18-04-2021",qtyrecived:"16",qtyaccepted:"14",qtydeclined:"2",remarks:"immediate Despatch of goods required"},
  ...
  public addQuantityyUpdatePopup(item) {
    let dialogRef = this.dialog.open(AddQuantityUpdatePopupComponent, {
      data:item,
      height: 'auto',
      width: '800px'
    });
