...
import { IndentPublishedComponent } from './indent-published/indent-published.component';
import { InvoicePublishedComponent } from './invoice-published/invoice-published.component';
import { ItemsPublishedComponent } from './items-published/items-published.component';
...
export class PublishedComponent implements OnInit {
  ...
  invoicepop(){
    this.dialog.open(InvoicePublishedComponent ,{
      height:'auto',
      width:'60%'
    });
  }    
  requsitionpop(){
    this.dialog.open(IndentPublishedComponent ,{
      height:'auto',
      width:'60%'
    });
  }    
  itemspop(){
    this.dialog.open(ItemsPublishedComponent,{
      height:'auto',
      width:'65%'
    });
  }    
