...
import { AddServicePerfomanceComponent } from './add-service-perfomance/add-service-perfomance.component';

@Component({
  selector: 'app-service-perfomance',
  templateUrl: './service-perfomance.component.html',
  styleUrls: ['./service-perfomance.component.scss']
})
export class ServicePerfomanceComponent implements OnInit {
  ...
  openActionTypeDialog(value) {
    let dialogRef = this.dialog.open(AddServicePerfomanceComponent, {
      data: value,
      height: 'auto',
      width: '600px',
  });
