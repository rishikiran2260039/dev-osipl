...
import { AdditemtounpublishComponent } from './additemtounpublish/additemtounpublish.component';

@Component({
  selector: 'app-items-unpublish-popup',
  templateUrl: './items-unpublish-popup.component.html',
  styleUrls: ['./items-unpublish-popup.component.scss']
})
export class ItemsUnpublishPopupComponent implements OnInit {
  ...
  additem(item)
  {
    let dialogRef = this.dialog.open(AdditemtounpublishComponent, {
      data: item,
      height:'auto',
      width:'1000px'
    });
