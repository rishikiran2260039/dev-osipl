...
export class EditUserComponent implements OnInit {
  ...
  constructor(public fb: FormBuilder, public dialogRef: MatDialogRef<EditUserComponent>, private service: UsersService, private alertService: AlertService,
    @Inject(MAT_DIALOG_DATA) public data: any) {
      if (this.data == null) {
        ...
        this.myGroup = this.fb.group({
          ...
          UserEmail: new FormControl(this.data.UserEmail, Validators.email),
  ...
  setvalues(val: any) {
    this.myGroup = this.fb.group({
      ...
      UserEmail: new FormControl(val.UserEmail, Validators.email),
