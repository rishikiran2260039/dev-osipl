...
@Component({
  selector: 'app-archived-item-pop-up',
  templateUrl: './archived-item-pop-up.component.html',
  styleUrls: ['./archived-item-pop-up.component.scss']
})
export class ArchivedItemPopUpComponent implements OnInit {
